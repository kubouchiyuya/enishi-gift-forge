...
2. Public visibility.
3. Author and rights display.
4. README wording that this is an independent AKATSUKI design.
5. Final Komainu, secret, mirror, fresh-clone, and read-back checks.

The public repository was created after the name and location were confirmed. Public README, tree, visibility, and commit were read back.
